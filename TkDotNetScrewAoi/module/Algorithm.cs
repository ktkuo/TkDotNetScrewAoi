...
namespace TkDotNetScrewAoi.module
{
    ...
    public class Algorithm
    {
        ...
        public static async Task<HObject> RoiRegion(HObject ho_imageRaw, HTuple roiX, HTuple roiY,HTuple roiSize)
        {
        ...
        public static async Task<Bitmap> GetBall(ENUM_InspectionMode enumInspectionMode_, Object lock_,HalconDotNet.HWindowControl hWindowControl, HObject ho_imageRaw, HTuple roiX,HTuple roiY,bool isSave_,string dirSave)
        {
